...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		...
		if ( isset( $_REQUEST['page'] ) ) {
			$page = esc_attr( wp_unslash( $_REQUEST['page'] ) );// Input var okay.
		}
		...
		if ( isset( $_REQUEST['page'] ) ) {// Input var okay.
			switch ( $page_url ) {
				...
				case 'mb_email_configuration':
					...
					if ( ! empty( $_REQUEST['access_token'] ) && isset( $_REQUEST['access_token'] ) ) {// Input var okay.
						$code                            = esc_attr( $_REQUEST['access_token'] );// Input var okay.
						...
						$update_email_configuration_array['meta_value'] = maybe_serialize( $update_email_configuration_data );
